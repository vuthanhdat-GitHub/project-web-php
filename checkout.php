...
<body>
    <nav>
        <label class="logo" id="logo">VUTHANHDAT.UNETI</label>
        <ul>
    ...
    <footer>
        <div class="social">
            <a href="https://www.facebook.com/vuthanhdat.uneti"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <a href="https://twitter.com/VThnht87527828"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            <a href="https://www.instagram.com/thanh_dat_ig/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        </div>
        <ul class="list">
            <li>
                <a href="./">Trang Chủ</a>
