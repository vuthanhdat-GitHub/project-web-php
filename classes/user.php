	...
	public function insert($data)
	{
		...
		if ($result_check) {
			...
			if ($result) {
				...
				$mail->Username   = "codedidungso123@gmail.com";
				$mail->Password   = "Tranhoai3001@";

				$mail->IsHTML(true);
				$mail->CharSet = 'UTF-8';	
				$mail->AddAddress($email, "recipient-name");
				$mail->SetFrom("codedidungso123@gmail.com", "Instrument Store");
				$mail->Subject = "Xác nhận email tài khoản - Instruments Store";
				$mail->Body = "<h3>Cảm ơn bạn đã đăng ký tài khoản tại website VUTHANHDAT.UNETI</h3></br>Đây là mã xác minh tài khoản của bạn: " . $captcha . "";
